...
use crate::certificate::{cancel_certificate_request, create_certificate_request, download_pkcs12, download_public_certificate, generate_certificate, list_user_certificates, list_all_certificates, list_expiring_certificates, list_pending_certificates, revoke_certificate};
        ...
        cfg.app_data(app_state.clone())
            ...
            .service(
                web::scope("")
                    ...
                    .route("/users/{user_id}/certificates/{cert_id}/generate", web::post().to(generate_certificate))
