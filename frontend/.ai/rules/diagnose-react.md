...
- Try not to double the code. If common code repeats, try to make separate function for it.
...
Don't make changes in code, but show summary of proposed changes, and wait for user action.
